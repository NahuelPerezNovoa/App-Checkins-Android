...
class AdaptadorCustom(items:ArrayList<Category>, var listener: ClickListener, var longClinckListener: LongClinckListener):RecyclerView.Adapter<AdaptadorCustom.ViewHolder>() {
    ...
    class ViewHolder(vista:View, listener: ClickListener, longClinckListener: LongClinckListener):RecyclerView.ViewHolder(vista),View.OnClickListener, View.OnLongClickListener{
        ...
        init {
            foto=vista.findViewById(R.id.ivFoto_categorias)
